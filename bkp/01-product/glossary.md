# Glosario de Términos — KeyGo

> **Descripción:** Diccionario unificado de conceptos, entidades y términos técnicos usados en KeyGo. Referencia única para onboarding de nuevos devs y alineación de vocabulario.
...
**Permisos:** Crear/suspender tenants, ver estadísticas globales, gestionar usuarios de plataforma  
**Navegación:** Dashboard global, tenants, usuarios de plataforma, estado del servicio  
**Valores posibles:** `ADMIN`
...
**Contexto:** Tenants  
**Sinónimos:** KEYGO_TENANT_ADMIN  
**Responsabilidad:** Gestión de una organización o tenant  
**Permisos:** Crear usuarios, roles, apps, memberships, planes del tenant  
**Navegación:** Dashboard tenant, usuarios, apps, memberships, sesiones, billing  
**Path ejemplo:** `/api/v1/tenants/{tenantSlug}/users` requiere `ADMIN_TENANT` con tenant_slug matching  
**Valores posibles:** `ADMIN_TENANT`
...
### **Client Secret**
Identificador secreto de una app OAuth2. Debe almacenarse en backend seguro (nunca frontend). Usado en token exchange.
...
Control de acceso basado en roles. Usuario tiene rol (ADMIN, ADMIN_TENANT, USER_TENANT, etc.) → puede/no acceder a recurso.
...
### **Tenant User (Rol)**
Usuario de una app dentro de un tenant. Puede ver su perfil, sesiones, cambiar password. No gestiona otros usuarios.

**Contexto:** Tenants/Account  
**Sinónimos:** KEYGO_USER, USER_TENANT  
...
**Mantener actualizado**: Agregar nuevos términos conforme aparezcan en propuestas y decisiones.
